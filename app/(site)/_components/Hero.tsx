    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container py-28 md:py-36">
        <motion.h1
          ...
          className="text-balance text-4xl font-bold tracking-tight text-white md:text-6xl font-[Space_Grotesk]"
        >
          <span className="bg-gradient-to-r from-[#7c3eff] via-[#a78bfa] to-[#22d3ee] bg-clip-text text-transparent">
            Des sites audacieux qui convertissent
          </span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          Wave Agency conçoit des expériences web rapides, élégantes et animées en React — taillées pour le SEO et la performance.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <a href="/contact" className="rounded-2xl bg-white/10 px-6 py-3 text-white backdrop-blur transition hover:bg-white/20">Demander un devis</a>
