  ...
  return (
    <html lang="fr">
      <head>
        ...
        <Script defer data-domain="wave-agency.vercel.app" src="https://plausible.io/js/script.js" />
      </head>
        ...
        <footer className="border-t border-white/10 bg-black px-6 py-10 text-zinc-400">
          <div className="container grid gap-6 md:grid-cols-3">
            ...
            <div className="text-sm">
              <p><a href=f"mailto:{site.email}" className="hover:text-white">{site.email}</a></p>
              <p className="mt-1">
