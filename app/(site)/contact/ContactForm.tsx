...
export default function ContactForm() {
  return (
    ...
    >
      ...
      <button type="submit" className="mt-2 inline-flex items-center justify-center rounded-2xl bg-white/10 px-6 py-3 text-white backdrop-blur transition hover:bg-white/20">
        Envoyer
      </button>
    </form>
  );
