...
export default function ContactForm() {
  return (
    ...
    >
      {/* Anti-captcha & sujet pour FormSubmit */}
      ...
      <label className="grid gap-1">
        ...
        <input
          name="name"
          required
          className="rounded-xl bg-white/5 px-3 py-2 text-white outline-none ring-1 ring-white/10 focus:ring-white/25"
      ...
      <button
        type="submit"
        className="mt-2 inline-flex items-center justify-center rounded-2xl bg-white/10 px-6 py-3 text-white backdrop-blur transition hover:bg-white/20"
      >
        Envoyer
      </button>
    </form>
